      ...
      <div className="bg-cover bg-center min-h-75 h-auto w-full py-2 px-10 md:px-30 flex flex-wrap justify-start items-center">
        <div className="max-w-800 flex flex-col items-center py-10 px-10 md:py-40 md:px-40 bg-red-100 rounded-lg ">
          ...
          <div className="flex justify-center">
            <Link href={"https://www.facebook.com"} target="_blank" className="mr-5 hover:cursor-pointer">
              <img
            ...
            <Link href={"https://www.linkedin.com/in/sayan-das-179b93226/"} target="_blank" className="mr-5 hover:cursor-pointer">
              <img
                className="w-6 h-6 md:w-8 md:h-8"
            ...
            <Link href={"https://www.instagram.com"} target="_blank" className="mr-5 hover:cursor-pointer">
              <img
                className="w-6 h-6 md:w-8 md:h-8"
            ...
            <Link href={"https://www.twitter.com"} target="_blank" className="hover:cursor-pointer">
              <img
                className="w-6 h-6 md:w-8 md:h-8"
